    ...
    <section className="comments">
      ...
      <form id="comments__form" className="comments__form">
        <label htmlFor="comments__profile-img">
          <input
            id="comments__profile-img"
            className="comments__profile-img"
            type="image"
            name="image"
            src={profile}
            alt="Mohan muruge side profile picture"
          />
        </label>
        <div className="comments__container">
          <label
            htmlFor="comments__input-message"
            className="comments__input-label"
          >
            JOIN THE CONVERSATION
            <input
              id="comments__input-message"
              className="comments__input-message"
              type="text"
